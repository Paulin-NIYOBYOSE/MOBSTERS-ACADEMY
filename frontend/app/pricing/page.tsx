...
export default function ServicesPage() {
  ...
  const PricingPlans = [
    ...
    },
    {
      ...
      price: "55",
      features: ["Access to daily forex signals", "Email notifications", "Priority support", "Exclusive analysis tools"],
    },
    {
      name: "Signal Plan - 1 Year",
      price: "145",
      features: ["Access to daily forex signals", "Email notifications", "Priority support", "Exclusive analysis tools", "Yearly performance reports"],
    },
  ];
