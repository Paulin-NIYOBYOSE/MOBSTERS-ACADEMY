...
export const ProgramCards = () => {
  const programs = [
    {
      id: "academy",
      title: "Beginner Full Course + Mentorship",
      ...
      keyFeatures: [
        ...
        "Trader community access",
        "Pre-weekly market breakdowns",
        "Psychology sessions",
      ],
      highlight: "Master trading in 6 months with full guidance and support",
      icon: Award,
      popular: true,
    },
    {
      ...
      subtitle: "For Struggling & Intermediate Traders",
      price: "$149",
      priceUnit: "/month",
      badge: "Ongoing Support",
      keyFeatures: [
        "Advanced trading journal",
        "Personalized trading planner",
        "Trading plan templates",
        "Weekly psychology sessions",
        "Pre-weekly market analysis",
        "Personalized trade signals",
        "Prop firm strategies",
      ],
      highlight: "Stop struggling, trade smarter with real guidance",
      icon: Users,
      popular: false,
    },
    {
      ...
      highlight: "Explore our community for free",
      icon: MessageSquare,
      popular: false,
    },
  ];
